...
import { Participant, Shift, FillMode, OffDay } from '@/lib/types'
...
function App() {
  ...
  const handleAddSamples = async () => {
    ...
    if (result.length >= settings.peoplePerShift) {
      try {
        await scheduleState.generate(result, settings, historyState.historicalShifts, manualState.manualShifts, 'ignore-existing-positions', offDaysState.offDays)
