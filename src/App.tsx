...
function App() {
  ...
  const handleGenerateSchedule = async () => {
    ...
    try {
      ...
      const newSchedule = generateSchedule(participantsList, currentSettings)
  ...
  const handleExport = () => {
    exportToJSON({ participants: participantsList, settings: currentSettings, schedule: currentSchedule })
